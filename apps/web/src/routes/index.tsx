        ...
        <div className="min-h-[calc(100vh-3rem)] flex flex-col">
            ...
            <section className="flex-1 flex flex-col items-center justify-center px-4 py-16 md:py-24">
                <div className="max-w-3xl mx-auto text-center space-y-6">
                    <h1 className="text-4xl md:text-6xl font-bold tracking-tight">
                        Organize tasks. <span className="text-primary">Ship faster.</span>
                    </h1>
                    <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto">
                        A Trello-like board to manage your tasks, collaborate with your team, and
                        get things done.
                    </p>
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        <div className="flex flex-col items-center text-center space-y-3">
                            ...
                            <p className="text-sm text-muted-foreground">
                                Drag-and-drop cards across lists. Visualize your workflow at a
                                glance.
                            </p>
                        </div>
                        <div className="flex flex-col items-center text-center space-y-3">
            ...
            <section className="border-t py-12 px-4">
                <div className="max-w-2xl mx-auto text-center">
                    <p className="text-muted-foreground mb-4">Ready to organize your work?</p>
                    <Link to="/sign-in">
